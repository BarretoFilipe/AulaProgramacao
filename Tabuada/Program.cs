internal class Program
{
    private static void Main(string[] args)
    {
        ...
        for (numero_tabuada = 1; numero_tabuada <= numero_de_vezes; numero_tabuada++)
        {
